...
if MFSK:
    TONES_PER_SECOND = 48  # Run valid_speeds.py for list of valid speeds.
    ...
    TONES_PER_SECOND = 1920  # Run valid_speeds.py for list of valid speeds.
...
GAUSSIAN = True  # When enabled, all anticlick options are ignored
if GAUSSIAN:
